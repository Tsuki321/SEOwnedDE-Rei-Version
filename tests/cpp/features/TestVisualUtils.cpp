...
TEST(VisualUtilsContracts, MainSourceContainsFeatureTokens) {
    ...
    EXPECT_NE(mainSource.find("m_mapFrameCache"), std::string::npos);
    ...
    EXPECT_NE(mainSource.find("BuildEntityCandidatesIfNeeded("), std::string::npos);
    ...
    EXPECT_NE(mainSource.find("BuildModelCandidatesIfNeeded("), std::string::npos);
